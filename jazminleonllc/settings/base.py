# flake8: noqa
"""
Django settings for jazminleonllc project.
...
DJANGO_ROOT = root.path('jazminleonllc')
...
ROOT_URLCONF = 'jazminleonllc.urls'
...
WSGI_APPLICATION = 'jazminleonllc.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///jazminleonllc'),
}
